<template>
  <main class="flex flex-col justify-center px-8">
    <section class="lg:pl-24">
      <p class="mb-3 text-2xl text-snazzy-gray-500 dark:text-snazzy-gray-300">{{ hello }}</p>
      <p class="text-2xl font-medium md:text-3xl">My name is Scott Voyles.</p>
      <p class="text-2xl md:text-3xl">I'm a frontend software developer and musician.</p>
