    ...
    <main class="flex items-center max-w-6xl px-8 mx-auto mt-8">
      <section class="flex-1 p-8 mb-16 md:mb-0 contact contact-left">
        ...
        >
          ...
          <button
            type="submit"
            class="transiton-colors duration-500 ease-in-out hover:bg-snazzy-gray-900 hover:text-snazzy-gray-100 dark:border-snazzy-white dark:hover:text-snazzy-gray-800 dark:hover:bg-snazzy-white"
          >
            Send
          </button>
        </form>
      ...
      <section
        class="flex flex-col items-start flex-1 p-8 mb-16 contact contact-right"
      >
        <h1 class="mb-4 font-medium">Thanks for stopping by</h1>
        <p class="mb-4">
          If you like my work, please feel free to write to me. I look forward
